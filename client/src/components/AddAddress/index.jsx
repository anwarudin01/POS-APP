      ...
      <Row>
        ...
        <Col md={6}>
          ...
          {/* <Form.Group className="mb-3" controlId="kabupaten">
            ...
            <CustomFormSelect onChange={(value) => updateValue('kabupaten', JSON.parse(value))} isInvalid={errors.kabupaten} code={getValues().provinsi?.value} location="kota?id_provinsi=" value={getValues()?.kabupaten?.value} />
          ...
          <Form.Group className="mb-3" controlId="kecamatan">
            ...
            <CustomFormSelect onChange={(value) => updateValue('kecamatan', JSON.parse(value))} isInvalid={errors.kecamatan} code={getValues().kabupaten?.value} location="kecamatan?id_kota=" value={getValues()?.kecamatan?.value} />
          ...
          <Form.Group className="mb-3" controlId="kelurahan">
            ...
            <CustomFormSelect onChange={(value) => updateValue('kelurahan', JSON.parse(value))} isInvalid={errors.kelurahan} code={getValues().kecamatan?.value} location="kelurahan?id_kecamatan=" value={getValues()?.kelurahan?.value} />
